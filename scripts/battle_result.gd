...
func _ready() -> void:
	...
	gold_value.text = "+%s" % _format_number(GameSession.last_result_gold)
	max_combo_value.text = "×%s" % _format_number(GameSession.last_result_max_combo)
	damage_value.text = _format_number(GameSession.last_result_damage_dealt)
